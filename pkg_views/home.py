    ...
    if len(user_input) != 3:
        ...
        if st.button('삼행시 만들기'):
            ...
            with pbar:
                ...
                sleep(3)
                pbar.change_progress('삼행시가 생성 되었습니다.', 10, 20)
                ...
                if not img_url:
                    ...
                    pbar.change_progress('이미지 생성에 실패했습니다. 기본 이미지를 사용합니다.', 30, 40)
                else:
                    pbar.change_progress('이미지 생성이 완료되었습니다.', 30, 40)
                pbar.change_progress('이미지를 저장 중 입니다.', 40, 50)
